...
#define POLLING_PERIOD (100U) /* milliseconds */
	...
	void MX_TOF_Process(void *_htim3, void *_hi2c3)
	{
		...
		while(1){
			...
			HAL_Delay(20);
			dis1 = getDistance(VL53L3A2_DEV_CENTER, Result, dis1);
			sta1 = (int)Result[VL53L3A2_DEV_CENTER].ZoneResult[0].Status[0];
			HAL_Delay(500);
		...
		// 	dis1 = getDistance(VL53L3A2_DEV_CENTER, Result, dis1);
		// 	dis0 = getDistance(VL53L3A2_DEV_LEFT, Result, dis0);
		// 	dis2 = getDistance(VL53L3A2_DEV_RIGHT, Result, dis2);
		// 	dis3 = getDistance(VL53L3A2_DEV_TOP, Result, dis3);
		// 	dis4 = getDistance(VL53L3A2_DEV_BOTTOM, Result, dis4);
		...
		// 	if (gestureDimming && (commando == NONE || commando == DIM))
		// 	{
		// 		commando = DIM;
		...
		// 		break;
		// 	}
		// 	HAL_GPIO_WritePin(LED_4_GPIO_Port, LED_4_Pin, objectPresent);
