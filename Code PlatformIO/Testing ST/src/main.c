...
int main(void)
{
  ...
  printf("Robbetje is %5d jaar oud\r\n", (uint8_t)15);
  ...
  while (1)
  {
	  ...
	  HAL_Delay(100);
	  _Bool btn1State = HAL_GPIO_ReadPin(BTN1_GPIO_Port, BTN1_Pin);
	  if(btn1State == 1){
		  //Wanneer we iets inlezen van de knop
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, LD2_Pin|LED_ORANGE_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LD2_Pin LED_ORANGE_Pin */
  GPIO_InitStruct.Pin = LD2_Pin|LED_ORANGE_Pin;
