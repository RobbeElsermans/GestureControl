...
/**
  ******************************************************************************
  * @file    53l3a2_ranging_sensor.h
  * @author  IMG SW Application Team
  * @brief   This file contains the common defines and functions prototypes for
  *          the 53l3a2_ranging_sensor.c driver.
  ******************************************************************************
  * @attention
  *
  * Copyright (c) 2022 STMicroelectronics.
...
/* Define to prevent recursive inclusion -------------------------------------*/
#ifndef XNUCLEO_53L3A2_RANGING_SENSOR_H
#define XNUCLEO_53L3A2_RANGING_SENSOR_H
...
/** @defgroup XNUCLEO_53L3A2_RANGING_SENSOR RANGING SENSOR
  * @{
  */

/** @defgroup XNUCLEO_53L3A2_RANGING_SENSOR_Exported_Constants Exported Constants
  * @{
  */
...
/** @defgroup XNUCLEO_53L3A2_RANGING_SENSOR_Exported_Types Exported Types
  * @{
  */
typedef struct
{
...
/** @defgroup XNUCLEO_53L3A2_RANGING_SENSOR_Exported_Variables Exported Variables
  * @{
  */
extern void *VL53L3A2_RANGING_SENSOR_CompObj[3U];
/**
  * @}
  */

/** @defgroup XNUCLEO_53L3A2_RANGING_SENSOR_Exported_Functions Exported Functions
  * @{
  */
...
#endif /* XNUCLEO_53L3A2_RANGING_SENSOR_H */
