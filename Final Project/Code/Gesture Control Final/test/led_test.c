...
void test_leds_pin_number(void)
{
    TEST_ASSERT_EQUAL(GPIO_PIN_0, LED_0_Pin);
    TEST_ASSERT_EQUAL(GPIOA, LED_0_GPIO_Port);

    TEST_ASSERT_EQUAL(GPIO_PIN_1, LED_1_Pin);
    TEST_ASSERT_EQUAL(GPIOA, LED_1_GPIO_Port);

    TEST_ASSERT_EQUAL(GPIO_PIN_6, LED_2_Pin);
    TEST_ASSERT_EQUAL(GPIOA, LED_2_GPIO_Port);

    TEST_ASSERT_EQUAL(GPIO_PIN_7, LED_3_Pin);
    TEST_ASSERT_EQUAL(GPIOA, LED_3_GPIO_Port);

    TEST_ASSERT_EQUAL(GPIO_PIN_0, LED_4_Pin);
    TEST_ASSERT_EQUAL(GPIOB, LED_4_GPIO_Port);
}
